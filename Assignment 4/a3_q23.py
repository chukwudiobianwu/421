...
cpt_l_true = Dnet.variable_node('L').cpt[(True,)]
cpt_l_false = Dnet.variable_node('L').cpt[(False,)]
...
ea_result = enumeration_ask('D', {'A': True, 'X': True}, Dnet)
rs_result = rejection_sampling('D', {'A': True, 'X': True}, Dnet, 100000)
lw_result = likelihood_weighting('D', {'A': True, 'X': True}, Dnet)
print(ea_result[True])
